...
const ProductsPage = () => {
  ...
  // Llama a fetchProducts cuando cambian los filtros o la página
  useEffect(() => {
  ...
  const handleScroll = useCallback(() => {
    ...
    // 1. No debe haber una carga en curso (loading === false)
    // 2. La página actual debe ser menor que el total de páginas
    // 3. El usuario debe estar cerca del final del scroll (a 500px del fondo)
  ...
  // --- NUEVO: Añadir y limpiar el event listener del scroll ---
  useEffect(() => {
