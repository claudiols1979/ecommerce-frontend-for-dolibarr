...
export const useHeroCarousel = () => {
  ...
  if (!context) {
    throw new Error('useHeroCarousel debe ser usado dentro de un HeroCarouselProvider');
  }
  return context;
};
...
export const HeroCarouselProvider = ({ children }) => {
  ...
  const defaultSlides = [
    ...
    {
      image: 'https://res.cloudinary.com/dl4k0gqfv/image/upload/v1758218247/cardmapr-nl-pwxESDWRwDE-unsplash_lny8bk.jpg',
    ...
    {
      image: 'https://res.cloudinary.com/dl4k0gqfv/image/upload/v1758213151/charlesdeluvio-FK81rxilUXg-unsplash_xrs3ih.jpg',
