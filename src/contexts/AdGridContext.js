...
export const AdGridProvider = ({ children }) => {
  ...
  const defaultItems = [
    {
      image: 'https://res.cloudinary.com/dl4k0gqfv/image/upload/v1754589040/syed-muhammad-baqir-zaidi-3qNVEa7SN_8-unsplash_jrfvpr.jpg',
    ...
    {
      image: 'https://res.cloudinary.com/dl4k0gqfv/image/upload/v1758213291/cut-collective-u94ywFnPedw-unsplash_z02shc.jpg',
      department: 'Calzado',
      title: 'Calzado',
      alt: 'Calzado de última moda'
    },
    {
      image: 'https://res.cloudinary.com/dl4k0gqfv/image/upload/v1758178128/christopher-gower-_aXa21cf7rY-unsplash_wao9x2.jpg',
      department: 'Electrónicos',
      title: 'Electrónicos',
      alt: 'Tecnología y electrónicos'
    },
    {
      image: 'https://res.cloudinary.com/dl4k0gqfv/image/upload/v1758478320/air_conditioner_zers0j.jpg',
      department: 'Aires Acondicionados',
      title: 'Aires Acondicionados',
      alt: 'Aires acondicionados y climatización'
    },
    {
      image: 'https://res.cloudinary.com/dl4k0gqfv/image/upload/v1758217151/catia-dombaxe-8IlqMcDYKA8-unsplash_jimlbl.jpg',
  ...
  const fetchGridItems = useCallback(async () => {
    ...
    try {
      ...
      setGridItems(defaultItems);
      setError('Error al cargar el grid de departamentos. Mostrando items por defecto.');
    } finally {
      setLoading(false);
    }
  }, [api]);
  ...
  return (
    <AdGridContext.Provider value={value}>
      {children}
